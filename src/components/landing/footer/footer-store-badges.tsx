  ...
  return (
    <div className={containerClass}>
      <a
        ...
        aria-label={`Download on ${t("appStore")}`}
      >
        ...
        <div className="flex flex-col">
          <span className={`${titleSize} text-white leading-tight`}>{t("appStore")}</span>
        </div>
      </a>
      ...
      <a
        ...
        rel="noopener noreferrer"
        className={`flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl ${padding} transition-all duration-200 ${hoverClass}`}
        aria-label={`Get it on ${t("googlePlay")}`}
      >
        ...
        <div className="flex flex-col">
          <span className={`${titleSize} text-white leading-tight`}>{t("googlePlay")}</span>
        </div>
      </a>
    </div>
  );
