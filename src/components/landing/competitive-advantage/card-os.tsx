...
export function CardOs({ mobile }: { mobile?: boolean }) {
  ...
  if (mobile) {
    return (
      <div className="bg-[#1E293B] min-h-[580px] max-h-[590px] p-6 relative overflow-hidden">
        <img alt="background" loading="lazy" className="absolute inset-0 object-cover z-0" src="/falak-held-by-hand.png" style={bgStyle} />
  ...
  return (
    <div className="min-h-[498px] max-h-[500px] rounded-3xl p-8 relative overflow-hidden bg-[#06070b]">
      <img alt="background" loading="lazy" className="absolute z-0" src="/falak-held-by-hand-desktop.png" style={{ position: "absolute", top: 0, right: 0, height: "100%", width: "60%", objectFit: "cover",scale: 1.05, objectPosition: "left center" }} />
